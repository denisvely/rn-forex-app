...
export { default as ChartIcon } from "./Simplex/SimplexTrade/ChartIcon/ChartIcon";
export { default as InvestAmount } from "./Simplex/SimplexTrade/InvestmentList/InvestAmount";
